    ...
    <div className='w-[100%] overflow-hidden'>
      <div className='w-[100%] lg:h-[140vh] h-[70vh] relative'>
        ...
        <div className='absolute lg:top-[30%] top-[75%] md:top-[80%] w-[100%] flex justify-center items-center gap-3 flex-wrap'>
          <button className='px-[20px] py-[10px] border-2 lg:border-white border-black lg:text-white text-black rounded-[10px] txet-[18px] font-light flex gap-2 cursor-pointer' onClick={()=>navigate('/allcourses')}><p className='mt-[2px]'>View All Courses</p> <SiViaplay className='w-[30px] h-[30px] lg:fill-white fill-black'/>
          </button>
