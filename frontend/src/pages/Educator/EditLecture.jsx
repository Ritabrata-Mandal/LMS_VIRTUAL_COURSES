...
const EditLecture = () => {
    ...
    }, [selectedLecture, navigate, courseId]);
    ...
    const removeLecture = async()=>{
        ...
        try {
           ...
           console.log("Before:", creatorCourseData);
            ...
            console.log("After:", creatorCourseData);
        ...
        <div className='w-full max-w-xl bg-white rounded-xl shadow-lg p-6 space-y-6'>
            ...
            <div className='space-y-4'>
                ...
                <div>
                    ...
                    <input type="file" className='w-full border border-gray-300 rounded-md p-2 file:mr-4 file:py-1 file:px-4 file:rounded-md file:border-0 file:text-sm file:bg-gray-700 file:text-white hover:file:bg-gray-500' required accept='video/*' onChange={(e)=>setVideoUrl(e.target.files[0])}/>
                </div>
