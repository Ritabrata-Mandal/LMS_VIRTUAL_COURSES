      ...
      <div className='w-[100%] min-h-screen p-4 sm:p-6 bg-gray-100'>
        <div className='flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-3'>
          ...
          <div className='flex items-center justify-center gap-3'>
            <FaArrowLeftLong className='h-[22px] w-[22px] cursor-pointer' onClick={()=>navigate('/dashboard')}/>
            ...
            <tbody>
              
                {
                  creatorCourseData?.map((course,idx)=>{
                    return <tr key={idx} className='border-b hover:bg-gray-50 transition duration-200'>
                      <td className='py-3 px-4 flex items-center gap-4'>
                        {course?.thumbnail ?  <img src={course?.thumbnail} className='w-25 h-14 object-cover rounded-md object-cover' alt="" /> : <img src={img} className='w-25 h-14 object-cover rounded-md object-cover' alt="" />}
        ...
        <div className='md:hidden space-y-4'>

          {
            ...
            return ( <div key={idx} className='bg-white rounded-lg shadow p-4 flex flex-col gap-3'>

                <div className='flex gap-4 items-center'>
                { course?.thumbnail ?  <img src={course?.thumbnail} className='w-16 h-16 rounded-md object-cover' /> : <img src={img} className='w-16 h-16 rounded-md object-cover' />}
