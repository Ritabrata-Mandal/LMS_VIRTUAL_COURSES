  ...
  return (
    ...
    <ScrollToTop/>
      <Routes>
        ...
        <Route path='/forget' element={userData ? <ForgetPassword/> : <SignUp/>} />

        <Route path='/editprofile' element={userData ? <EditProfile/> : <SignUp/>} />

        <Route path='/allcourses' element={userData ? <AllCourses/> : <SignUp/>} />
